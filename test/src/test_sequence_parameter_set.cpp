...
{
    std::vector<uint8_t> data = {0x67, 0x64, 0x00, 0x15, 0xac, 0xc8, 0x60,
                                 0x20, 0x09, 0x6c, 0x04, 0x40, 0x00, 0x00,
                                 0x03, 0x00, 0x40, 0x00, 0x00, 0x07, 0xa3,
                                 0xc5, 0x8b, 0x67, 0x80};
...
{
    std::vector<uint8_t> data = {0x67, 0x42, 0x00, 0x20, 0xE2, 0x90, 0x0A,
                                 0x00, 0xCB, 0x60, 0x2D, 0xC0, 0x40, 0x40,
                                 0x69, 0x07, 0x89, 0x11, 0x50};
...
{
    std::vector<uint8_t> data = {0x67, 0x64, 0x00, 0x2A, 0xAD, 0x84, 0x01, 0x0C,
...
TEST(test_sequence_parameter_set, width3840_height2160)
{
    std::vector<uint8_t> data = {
        0x67, 0x64, 0x00, 0x33, 0xAC, 0xD1, 0x00, 0x3C, 0x00, 0x43, 0xEC,
        0x05, 0x48, 0x08, 0x08, 0x0A, 0x00, 0x00, 0x07, 0xD2, 0x00, 0x01,
        0xD4, 0xC1, 0xC8, 0x00, 0x00, 0x0B, 0xEB, 0xC2, 0x00, 0x00, 0x05,
        0xF5, 0xBD, 0xD4, 0x98, 0x60, 0x1F, 0x18, 0x31, 0x12};
...
TEST(test_sequence_parameter_set, width560_height320)
{
    ...
    std::vector<uint8_t> data = {
        0x67, 0x42, 0xC0, 0x1E, 0xD9, 0x00, 0x8C, 0x29, 0xB0, 0x11, 0x00, 0x00,
